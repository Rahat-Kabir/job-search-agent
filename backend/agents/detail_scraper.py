...
DETAIL_SCRAPER_PROMPT = """\
You are a job detail extractor. Scrape job posting URLs and extract structured details.
...
[{"url": "https://...", "salary": "$120k-150k" or null,
"description": "2-3 sentence summary",
"requirements": ["req1", "req2"],
"benefits": ["benefit1", "benefit2"],
"apply_url": "direct application URL if different"}]
...
def get_detail_scraper_config() -> dict:
    ...
    return {
        "name": "detail-scraper",
        "description": (
            "Deep-scrape selected job URLs to extract salary,"
            " description, requirements, and benefits."
            " Only use for user-selected jobs."
        ),
